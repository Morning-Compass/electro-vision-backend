...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(auth::full_user::delete::delete_full_user)
            .service(auth::full_user::read::get_full_user)
            .service(auth::full_user::update::update_full_user)
            .service(auth::full_user::register::register_full_user)
            ...
            .service(buisness_logic::workspace::delete_workspace::delete_workspace)
            ...
            .service(buisness_logic::problems::create_problem::create_problem)
